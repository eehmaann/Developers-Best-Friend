...
<form method='POST' action='/lorem'>
    {{ csrf_field() }}
    <p> How many paragraphs would you like? <input type='number' name='paragraphsNumber' min="0", max="100">
    <input type='submit' value='Give me Content!'></p>
</form>
<form method='POST' action='/ruser'>
    {{ csrf_field() }}
    <p> How many users would you like to have generated?<input type='number' name='peopleNumber' min="0", max="20">
